...
st.markdown("---")
st.markdown("**💡 Tips:**")
st.markdown("- Enhanced Pattern Matching works best for consistent incident report formats")
st.markdown("- Enable preprocessing for better data quality and column name consistency")
st.markdown("- The app will automatically detect text columns even with different names")